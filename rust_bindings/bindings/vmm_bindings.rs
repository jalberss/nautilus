...
extern "C" {
    pub fn nk_vmm_start_vm(
        name: *mut ::libc::c_char,
        image: *mut ::libc::c_void,
        cpu_mask: ::libc::c_uint,
    ) -> *mut ::libc::c_void;
}
extern "C" {
    pub fn nk_vmm_stop_vm(vm: *mut ::libc::c_void) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_vmm_free_vm(vm: *mut ::libc::c_void) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_vmm_pause_vm(vm: *mut ::libc::c_void) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_vmm_continue_vm(vm: *mut ::libc::c_void) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_vmm_reset_vm(vm: *mut ::libc::c_void) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_vmm_move_vm_core(
        vm: *mut ::libc::c_void,
        vcore: ::libc::c_int,
        pcore: ::libc::c_int,
    ) -> ::libc::c_int;
...
extern "C" {
    pub fn nk_vmm_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_vmm_deinit() -> ::libc::c_int;
}
