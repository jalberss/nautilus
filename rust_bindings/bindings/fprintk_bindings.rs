...
pub const FS_NAME_LEN: u32 = 32;
pub const MOUNT_PATH_LEN: u32 = 1024;
pub const NK_FS_READONLY: u32 = 1;
...
pub const FPRINTK_BUFMAX: u32 = 128;
pub const FS_WRITE_MAX: u32 = 1024;
...
extern "C" {
    pub fn nk_fs_ext2_attach(
        devname: *mut ::libc::c_char,
        fsname: *mut ::libc::c_char,
        readonly: ::libc::c_int,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_fs_ext2_detach(fsname: *mut ::libc::c_char) -> ::libc::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_fs_stat {
    pub st_size: u64,
}
#[test]
fn bindgen_test_layout_nk_fs_stat() {
    assert_eq!(
        ::core::mem::size_of::<nk_fs_stat>(),
        8usize,
        concat!("Size of: ", stringify!(nk_fs_stat))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_fs_stat>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_fs_stat))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_stat>())).st_size as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_stat),
            "::",
            stringify!(st_size)
        )
    );
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_fs_int {
    pub stat_path: ::core::option::Option<
        unsafe extern "C" fn(
    ...
    >,
    pub create_file: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            path: *mut ::libc::c_char,
        ) -> *mut ::libc::c_void,
    >,
    pub create_dir: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            path: *mut ::libc::c_char,
        ) -> ::libc::c_int,
    >,
    pub exists: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            path: *mut ::libc::c_char,
        ) -> ::libc::c_int,
    ...
    >,
    pub trunc_file: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            file: *mut ::libc::c_void,
            len: off_t,
    ...
    pub close_file: ::core::option::Option<
        unsafe extern "C" fn(state: *mut ::libc::c_void, file: *mut ::libc::c_void),
    >,
}
#[test]
fn bindgen_test_layout_nk_fs_int() {
    assert_eq!(
        ::core::mem::size_of::<nk_fs_int>(),
        88usize,
        concat!("Size of: ", stringify!(nk_fs_int))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_fs_int>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_fs_int))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).stat_path as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).create_file as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).create_dir as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
            "::",
            stringify!(create_dir)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).exists as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).remove as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).open_file as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).stat as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).trunc_file as *const _ as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
            "::",
            stringify!(trunc_file)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).read_file as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).write_file as *const _ as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs_int>())).close_file as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs_int),
...
pub struct nk_fs {
    ...
    pub mount_path: [::libc::c_char; 1024usize],
    pub fs_list_node: list_head,
    pub flags: u64,
    pub state: *mut ::libc::c_void,
    pub interface: *mut nk_fs_int,
}
#[test]
fn bindgen_test_layout_nk_fs() {
    assert_eq!(
        ::core::mem::size_of::<nk_fs>(),
        1096usize,
        concat!("Size of: ", stringify!(nk_fs))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_fs>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_fs))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs>())).name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs>())).mount_path as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs),
            "::",
            stringify!(mount_path)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs>())).fs_list_node as *const _ as usize },
        1056usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs),
            "::",
            stringify!(fs_list_node)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs>())).flags as *const _ as usize },
        1072usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs>())).state as *const _ as usize },
        1080usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_fs>())).interface as *const _ as usize },
        1088usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_fs),
...
extern "C" {
    pub fn nk_fs_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_fs_deinit() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_fs_register(
...
extern "C" {
    pub fn nk_fs_unregister(fs: *mut nk_fs) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_fs_find(name: *mut ::libc::c_char) -> *mut nk_fs;
}
extern "C" {
    pub fn nk_fs_dump_filesystems();
}
extern "C" {
    pub fn nk_fs_dump_files();
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_fs_open_file_state {
    _unused: [u8; 0],
}
pub type nk_fs_fd_t = *mut nk_fs_open_file_state;
extern "C" {
    pub fn nk_fs_stat(path: *mut ::libc::c_char, st: *mut nk_fs_stat) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_fs_truncate(path: *mut ::libc::c_char, len: off_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_fs_creat(path: *mut ::libc::c_char, mode: ::libc::c_int) -> nk_fs_fd_t;
}
extern "C" {
    pub fn nk_fs_open(
        path: *mut ::libc::c_char,
...
extern "C" {
    pub fn nk_fs_fstat(fd: nk_fs_fd_t, st: *mut nk_fs_stat) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_fs_ftruncate(fd: nk_fs_fd_t, len: off_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_fs_seek(fd: nk_fs_fd_t, position: off_t, whence: ::libc::c_int) -> off_t;
}
extern "C" {
    pub fn nk_fs_tell(fd: nk_fs_fd_t) -> isize;
}
extern "C" {
    pub fn nk_fs_read(fd: nk_fs_fd_t, buf: *mut ::libc::c_void, len: usize) -> isize;
}
extern "C" {
    pub fn nk_fs_write(fd: nk_fs_fd_t, buf: *mut ::libc::c_void, len: usize) -> isize;
}
extern "C" {
    pub fn nk_fs_close(fd: nk_fs_fd_t) -> ::libc::c_int;
}
extern "C" {
    pub fn test_fs();
}
...
extern "C" {
    #[link_name = "\u{1}__RAMDISK_START"]
    pub static mut __RAMDISK_START: u8;
}
extern "C" {
    #[link_name = "\u{1}__RAMDISK_END"]
    pub static mut __RAMDISK_END: u8;
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fprintk_state {
    pub buf: [::libc::c_char; 128usize],
    pub idx: ::libc::c_uint,
    pub fd: nk_fs_fd_t,
}
#[test]
fn bindgen_test_layout_fprintk_state() {
    assert_eq!(
        ::core::mem::size_of::<fprintk_state>(),
        144usize,
        concat!("Size of: ", stringify!(fprintk_state))
    );
    assert_eq!(
        ::core::mem::align_of::<fprintk_state>(),
        8usize,
        concat!("Alignment of ", stringify!(fprintk_state))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<fprintk_state>())).buf as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(fprintk_state),
            "::",
            stringify!(buf)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<fprintk_state>())).idx as *const _ as usize },
        128usize,
        concat!(
            "Offset of field: ",
            stringify!(fprintk_state),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<fprintk_state>())).fd as *const _ as usize },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(fprintk_state),
...
extern "C" {
    pub fn fprintk(fd: nk_fs_fd_t, fmt: *const ::libc::c_char, ...) -> ::libc::c_int;
}
