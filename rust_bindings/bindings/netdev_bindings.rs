...
pub const DEV_NAME_LEN: u32 = 32;
pub const ETHER_MAC_LEN: u32 = 6;
...
pub const nk_dev_type_t_NK_DEV_GENERIC: nk_dev_type_t = 0;
pub const nk_dev_type_t_NK_DEV_INTR: nk_dev_type_t = 1;
pub const nk_dev_type_t_NK_DEV_TIMER: nk_dev_type_t = 2;
pub const nk_dev_type_t_NK_DEV_BUS: nk_dev_type_t = 3;
pub const nk_dev_type_t_NK_DEV_CHAR: nk_dev_type_t = 4;
pub const nk_dev_type_t_NK_DEV_BLK: nk_dev_type_t = 5;
pub const nk_dev_type_t_NK_DEV_NET: nk_dev_type_t = 6;
pub type nk_dev_type_t = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_dev_int {
    pub open:
        ::core::option::Option<unsafe extern "C" fn(state: *mut ::libc::c_void) -> ::libc::c_int>,
    pub close:
        ::core::option::Option<unsafe extern "C" fn(state: *mut ::libc::c_void) -> ::libc::c_int>,
}
#[test]
fn bindgen_test_layout_nk_dev_int() {
    assert_eq!(
        ::core::mem::size_of::<nk_dev_int>(),
        16usize,
        concat!("Size of: ", stringify!(nk_dev_int))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_dev_int>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_dev_int))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev_int>())).open as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev_int),
            "::",
            stringify!(open)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev_int>())).close as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev_int),
...
pub struct nk_dev {
    ...
    pub type_: nk_dev_type_t,
    pub flags: u64,
    pub dev_list_node: list_head,
    pub state: *mut ::libc::c_void,
    pub interface: *mut nk_dev_int,
    pub waiting_threads: *mut nk_thread_queue_t,
}
#[test]
fn bindgen_test_layout_nk_dev() {
    assert_eq!(
        ::core::mem::size_of::<nk_dev>(),
        88usize,
        concat!("Size of: ", stringify!(nk_dev))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_dev>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_dev))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev>())).name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev>())).type_ as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev>())).flags as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev>())).dev_list_node as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev),
            "::",
            stringify!(dev_list_node)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev>())).state as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev>())).interface as *const _ as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_dev>())).waiting_threads as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_dev),
...
pub const nk_dev_request_type_t_NK_DEV_REQ_BLOCKING: nk_dev_request_type_t = 0;
pub const nk_dev_request_type_t_NK_DEV_REQ_NONBLOCKING: nk_dev_request_type_t = 1;
pub const nk_dev_request_type_t_NK_DEV_REQ_CALLBACK: nk_dev_request_type_t = 2;
pub type nk_dev_request_type_t = u32;
extern "C" {
    pub fn nk_dev_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_dev_deinit() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_dev_register(
        name: *mut ::libc::c_char,
        type_: nk_dev_type_t,
        flags: u64,
        inter: *mut nk_dev_int,
        state: *mut ::libc::c_void,
    ) -> *mut nk_dev;
}
extern "C" {
    pub fn nk_dev_unregister(arg1: *mut nk_dev) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_dev_find(name: *mut ::libc::c_char) -> *mut nk_dev;
}
extern "C" {
    pub fn nk_dev_wait(
        arg1: *mut nk_dev,
...
extern "C" {
    pub fn nk_dev_signal(arg1: *mut nk_dev);
}
extern "C" {
    pub fn nk_dev_dump_devices();
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_net_dev_characteristics {
    pub mac: [u8; 6usize],
    pub min_tu: u64,
    pub max_tu: u64,
    pub packet_size_to_buffer_size:
        ::core::option::Option<unsafe extern "C" fn(packet_size: u64) -> u64>,
}
#[test]
fn bindgen_test_layout_nk_net_dev_characteristics() {
    assert_eq!(
        ::core::mem::size_of::<nk_net_dev_characteristics>(),
        32usize,
        concat!("Size of: ", stringify!(nk_net_dev_characteristics))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_net_dev_characteristics>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_net_dev_characteristics))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_net_dev_characteristics>())).mac as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_net_dev_characteristics),
            "::",
            stringify!(mac)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_net_dev_characteristics>())).min_tu as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_net_dev_characteristics>())).max_tu as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_net_dev_characteristics>())).packet_size_to_buffer_size
                as *const _ as usize
        },
        24usize,
        concat!(
            ...
            stringify!(nk_net_dev_characteristics),
            "::",
            stringify!(packet_size_to_buffer_size)
        )
    );
}
pub const nk_net_dev_status_t_NK_NET_DEV_STATUS_SUCCESS: nk_net_dev_status_t = 0;
pub const nk_net_dev_status_t_NK_NET_DEV_STATUS_ERROR: nk_net_dev_status_t = 1;
pub type nk_net_dev_status_t = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_net_dev_int {
    pub dev_int: nk_dev_int,
    pub get_characteristics: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            c: *mut nk_net_dev_characteristics,
        ) -> ::libc::c_int,
    >,
    pub post_receive: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            dest: *mut u8,
            len: u64,
            callback: ::core::option::Option<
                unsafe extern "C" fn(status: nk_net_dev_status_t, context: *mut ::libc::c_void),
            >,
...
#[test]
fn bindgen_test_layout_nk_net_dev_int() {
    assert_eq!(
        ::core::mem::size_of::<nk_net_dev_int>(),
        40usize,
        concat!("Size of: ", stringify!(nk_net_dev_int))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_net_dev_int>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_net_dev_int))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_net_dev_int>())).dev_int as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_net_dev_int),
            "::",
            stringify!(dev_int)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_net_dev_int>())).get_characteristics as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_net_dev_int),
            "::",
            stringify!(get_characteristics)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_net_dev_int>())).post_receive as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_net_dev_int),
            "::",
            stringify!(post_receive)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_net_dev_int>())).post_send as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_net_dev_int),
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_net_dev {
    pub dev: nk_dev,
}
#[test]
fn bindgen_test_layout_nk_net_dev() {
    assert_eq!(
        ::core::mem::size_of::<nk_net_dev>(),
        88usize,
        concat!("Size of: ", stringify!(nk_net_dev))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_net_dev>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_net_dev))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_net_dev>())).dev as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_net_dev),
            "::",
            stringify!(dev)
        )
    );
...
extern "C" {
    pub fn nk_net_dev_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_net_dev_deinit() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_net_dev_register(
        name: *mut ::libc::c_char,
        flags: u64,
        inter: *mut nk_net_dev_int,
        state: *mut ::libc::c_void,
    ) -> *mut nk_net_dev;
}
extern "C" {
    pub fn nk_net_dev_unregister(arg1: *mut nk_net_dev) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_net_dev_find(name: *mut ::libc::c_char) -> *mut nk_net_dev;
}
extern "C" {
    pub fn nk_net_dev_get_characteristics(
        d: *mut nk_net_dev,
        c: *mut nk_net_dev_characteristics,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_net_dev_receive_packet(
        dev: *mut nk_net_dev,
        dest: *mut u8,
        len: u64,
        type_: nk_dev_request_type_t,
        callback: ::core::option::Option<
            unsafe extern "C" fn(status: nk_net_dev_status_t, state: *mut ::libc::c_void),
        >,
        state: *mut ::libc::c_void,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_net_dev_send_packet(
        dev: *mut nk_net_dev,
        src: *mut u8,
        len: u64,
        type_: nk_dev_request_type_t,
