...
fn bindgen_test_layout___jmp_buf_tag() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<__jmp_buf_tag>())).__jmpbuf as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn test_setlong() -> ::libc::c_int;
}
extern "C" {
    pub fn setjmp(env: *mut __jmp_buf_tag) -> ::libc::c_int;
}
extern "C" {
    pub fn longjmp(env: *mut __jmp_buf_tag, val: ::libc::c_int);
}
