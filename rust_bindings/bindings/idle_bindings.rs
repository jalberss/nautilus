...
pub const ICON_WIDTH: u32 = 4;
pub const ICON_HEIGHT: u32 = 4;
...
extern "C" {
    pub fn screensaver(in_: *mut ::libc::c_void, out: *mut *mut ::libc::c_void);
}
extern "C" {
    pub fn side_screensaver(in_: *mut ::libc::c_void, out: *mut *mut ::libc::c_void);
}
extern "C" {
    pub fn idle(in_: *mut ::libc::c_void, out: *mut *mut ::libc::c_void);
}
