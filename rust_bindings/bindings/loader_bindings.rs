...
extern "C" {
    pub fn nk_load_exec(path: *mut ::libc::c_char) -> *mut nk_exec;
}
extern "C" {
    pub fn nk_start_exec(
        exec: *mut nk_exec,
        in_: *mut ::libc::c_void,
...
extern "C" {
    pub fn nk_unload_exec(exec: *mut nk_exec) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_loader_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_loader_deinit();
}
