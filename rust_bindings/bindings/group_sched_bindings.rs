...
pub const MAX_GROUP_NAME: u32 = 32;
...
pub struct nk_thread_group {
    _unused: [u8; 0],
}
pub type nk_thread_group_t = nk_thread_group;
extern "C" {
    pub fn nk_thread_group_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_deinit() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_create(name: *mut ::libc::c_char) -> *mut nk_thread_group_t;
}
extern "C" {
    pub fn nk_thread_group_attach_state(
        group: *mut nk_thread_group_t,
        state: *mut ::libc::c_void,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_detach_state(group: *mut nk_thread_group_t) -> *mut ::libc::c_void;
}
extern "C" {
    pub fn nk_thread_group_get_state(group: *mut nk_thread_group_t) -> *mut ::libc::c_void;
}
extern "C" {
    pub fn nk_thread_group_find(name: *mut ::libc::c_char) -> *mut nk_thread_group_t;
}
extern "C" {
    pub fn nk_thread_group_join(group: *mut nk_thread_group_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_leave(group: *mut nk_thread_group_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_barrier(group: *mut nk_thread_group_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_election(group: *mut nk_thread_group_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_reset_leader(group: *mut nk_thread_group_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_check_leader(group: *mut nk_thread_group_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_broadcast(
        group: *mut nk_thread_group_t,
...
extern "C" {
    pub fn nk_thread_group_broadcast_terminate(group: *mut nk_thread_group_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_delete(group: *mut nk_thread_group_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_thread_group_get_size(group: *mut nk_thread_group_t) -> u64;
}
extern "C" {
    pub fn nk_group_sched_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_group_sched_deinit() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_group_sched_change_constraints(
        group: *mut nk_thread_group_t,
        group_constraints: *mut nk_sched_constraints,
    ) -> ::libc::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
