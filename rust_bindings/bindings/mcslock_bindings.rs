...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_mcs_lock {
    pub next: *mut nk_mcs_lock,
    pub locked: ::libc::c_int,
}
#[test]
fn bindgen_test_layout_nk_mcs_lock() {
    assert_eq!(
        ::core::mem::size_of::<nk_mcs_lock>(),
        16usize,
        concat!("Size of: ", stringify!(nk_mcs_lock))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_mcs_lock>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_mcs_lock))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_mcs_lock>())).next as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_mcs_lock),
            "::",
            stringify!(next)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_mcs_lock>())).locked as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_mcs_lock),
...
pub type nk_mcs_lock_t = nk_mcs_lock;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sys_info {
    pub _address: u8,
