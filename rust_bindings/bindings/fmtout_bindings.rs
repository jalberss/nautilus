...
pub struct Output_Sink {
    pub Emit: ::core::option::Option<unsafe extern "C" fn(o: *mut Output_Sink, ch: ::libc::c_int)>,
    pub Finish: ::core::option::Option<unsafe extern "C" fn(o: *mut Output_Sink)>,
}
#[test]
fn bindgen_test_layout_Output_Sink() {
    assert_eq!(
        ::core::mem::size_of::<Output_Sink>(),
        16usize,
        concat!("Size of: ", stringify!(Output_Sink))
    );
    assert_eq!(
        ::core::mem::align_of::<Output_Sink>(),
        8usize,
        concat!("Alignment of ", stringify!(Output_Sink))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<Output_Sink>())).Emit as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(Output_Sink),
            "::",
            stringify!(Emit)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<Output_Sink>())).Finish as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(Output_Sink),
