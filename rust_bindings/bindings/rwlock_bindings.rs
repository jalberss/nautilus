...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_rwlock {
    pub lock: spinlock_t,
    pub readers: ::libc::c_uint,
}
#[test]
fn bindgen_test_layout_nk_rwlock() {
    assert_eq!(
        ::core::mem::size_of::<nk_rwlock>(),
        8usize,
        concat!("Size of: ", stringify!(nk_rwlock))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_rwlock>(),
        4usize,
        concat!("Alignment of ", stringify!(nk_rwlock))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_rwlock>())).lock as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_rwlock),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_rwlock>())).readers as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_rwlock),
...
pub type nk_rwlock_t = nk_rwlock;
extern "C" {
    pub fn nk_rwlock_init(l: *mut nk_rwlock_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_rwlock_rd_lock(l: *mut nk_rwlock_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_rwlock_wr_lock(l: *mut nk_rwlock_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_rwlock_rd_unlock(l: *mut nk_rwlock_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_rwlock_wr_unlock(l: *mut nk_rwlock_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_rwlock_wr_lock_irq_save(l: *mut nk_rwlock_t) -> u8;
}
extern "C" {
    pub fn nk_rwlock_wr_unlock_irq_restore(l: *mut nk_rwlock_t, flags: u8) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_rwlock_test();
}
