...
pub const NK_CHARDEV_READABLE: u32 = 1;
pub const NK_CHARDEV_WRITEABLE: u32 = 2;
pub const NK_CHARDEV_ERROR: u32 = 4;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_char_dev_characteristics {}
#[test]
fn bindgen_test_layout_nk_char_dev_characteristics() {
    assert_eq!(
        ::core::mem::size_of::<nk_char_dev_characteristics>(),
        0usize,
        concat!("Size of: ", stringify!(nk_char_dev_characteristics))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_char_dev_characteristics>(),
        1usize,
        concat!("Alignment of ", stringify!(nk_char_dev_characteristics))
    );
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_char_dev_int {
    pub dev_int: nk_dev_int,
    pub get_characteristics: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            c: *mut nk_char_dev_characteristics,
        ) -> ::libc::c_int,
    >,
    pub read: ::core::option::Option<
        unsafe extern "C" fn(state: *mut ::libc::c_void, dest: *mut u8) -> ::libc::c_int,
    >,
    pub write: ::core::option::Option<
        unsafe extern "C" fn(state: *mut ::libc::c_void, src: *mut u8) -> ::libc::c_int,
    >,
    pub status:
        ::core::option::Option<unsafe extern "C" fn(state: *mut ::libc::c_void) -> ::libc::c_int>,
}
#[test]
fn bindgen_test_layout_nk_char_dev_int() {
    assert_eq!(
        ::core::mem::size_of::<nk_char_dev_int>(),
        48usize,
        concat!("Size of: ", stringify!(nk_char_dev_int))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_char_dev_int>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_char_dev_int))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_char_dev_int>())).dev_int as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_char_dev_int),
            "::",
            stringify!(dev_int)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_char_dev_int>())).get_characteristics as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_char_dev_int>())).read as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_char_dev_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_char_dev_int>())).write as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_char_dev_int),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_char_dev_int>())).status as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_char_dev_int),
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_char_dev {
    pub dev: nk_dev,
}
#[test]
fn bindgen_test_layout_nk_char_dev() {
    assert_eq!(
        ::core::mem::size_of::<nk_char_dev>(),
        88usize,
        concat!("Size of: ", stringify!(nk_char_dev))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_char_dev>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_char_dev))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_char_dev>())).dev as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_char_dev),
            "::",
            stringify!(dev)
        )
    );
...
extern "C" {
    pub fn nk_char_dev_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_char_dev_deinit() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_char_dev_register(
        name: *mut ::libc::c_char,
        flags: u64,
        inter: *mut nk_char_dev_int,
        state: *mut ::libc::c_void,
    ) -> *mut nk_char_dev;
}
extern "C" {
    pub fn nk_char_dev_unregister(arg1: *mut nk_char_dev) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_char_dev_find(name: *mut ::libc::c_char) -> *mut nk_char_dev;
}
extern "C" {
    pub fn nk_char_dev_get_characteristics(
        d: *mut nk_char_dev,
        c: *mut nk_char_dev_characteristics,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_char_dev_read(
        dev: *mut nk_char_dev,
        count: u64,
        dest: *mut u8,
...
extern "C" {
    pub fn nk_char_dev_status(dev: *mut nk_char_dev) -> ::libc::c_int;
}
