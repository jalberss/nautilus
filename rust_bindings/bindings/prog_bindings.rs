...
pub struct nk_prog_info {
    ...
    pub mod_: *mut multiboot_mod,
    pub entry_addr: *mut ::libc::c_void,
    pub argc: ::libc::c_int,
    pub argv: *mut *mut ::libc::c_char,
}
#[test]
fn bindgen_test_layout_nk_prog_info() {
    assert_eq!(
        ::core::mem::size_of::<nk_prog_info>(),
        40usize,
        concat!("Size of: ", stringify!(nk_prog_info))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_prog_info>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_prog_info))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_prog_info>())).name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_prog_info),
            "::",
            stringify!(name)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_prog_info>())).mod_ as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_prog_info),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_prog_info>())).entry_addr as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_prog_info),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_prog_info>())).argc as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_prog_info),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_prog_info>())).argv as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_prog_info),
...
extern "C" {
    pub fn handle_prog_cmd(buf: *mut ::libc::c_char) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_prog_init(naut: *mut naut_info) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_prog_run(naut: *mut naut_info) -> ::libc::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
