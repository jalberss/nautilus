...
extern "C" {
    pub fn __acpi_acquire_global_lock(lock: *mut ::libc::c_uint) -> ::libc::c_int;
}
extern "C" {
    pub fn __acpi_release_global_lock(lock: *mut ::libc::c_uint) -> ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_lapic"]
    pub static mut acpi_lapic: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_ioapic"]
    pub static mut acpi_ioapic: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_noirq"]
    pub static mut acpi_noirq: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_strict"]
    pub static mut acpi_strict: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_disabled"]
    pub static mut acpi_disabled: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_pci_disabled"]
    pub static mut acpi_pci_disabled: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_skip_timer_override"]
    pub static mut acpi_skip_timer_override: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_use_timer_override"]
    pub static mut acpi_use_timer_override: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_fix_pin2_polarity"]
    pub static mut acpi_fix_pin2_polarity: ::libc::c_int;
}
extern "C" {
    #[link_name = "\u{1}acpi_numa"]
    pub static mut acpi_numa: ::libc::c_int;
}
extern "C" {
    pub fn x86_acpi_numa_init() -> ::libc::c_int;
}
