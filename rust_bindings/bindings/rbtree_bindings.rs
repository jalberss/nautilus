...
pub struct rb_node {
    pub rb_parent_color: ::libc::c_ulong,
...
fn bindgen_test_layout_rb_node() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<rb_node>())).rb_parent_color as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_node),
...
extern "C" {
    pub fn nk_rb_insert_color(arg1: *mut rb_node, arg2: *mut rb_root);
}
extern "C" {
    pub fn nk_rb_erase(arg1: *mut rb_node, arg2: *mut rb_root);
}
extern "C" {
    pub fn nk_rb_next(arg1: *mut rb_node) -> *mut rb_node;
}
extern "C" {
    pub fn nk_rb_prev(arg1: *mut rb_node) -> *mut rb_node;
}
extern "C" {
    pub fn nk_rb_first(arg1: *mut rb_root) -> *mut rb_node;
}
extern "C" {
    pub fn nk_rb_last(arg1: *mut rb_root) -> *mut rb_node;
}
extern "C" {
    pub fn nk_rb_replace_node(victim: *mut rb_node, new: *mut rb_node, root: *mut rb_root);
}
