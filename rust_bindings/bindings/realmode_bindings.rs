...
pub struct nk_real_mode_int_args {
    pub vector: u8,
    pub blank: u8,
    pub ax: u16,
    pub bx: u16,
...
#[test]
fn bindgen_test_layout_nk_real_mode_int_args() {
    assert_eq!(
        ::core::mem::size_of::<nk_real_mode_int_args>(),
        32usize,
        concat!("Size of: ", stringify!(nk_real_mode_int_args))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_real_mode_int_args>(),
        2usize,
        concat!("Alignment of ", stringify!(nk_real_mode_int_args))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).vector as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
            "::",
            stringify!(vector)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).blank as *const _ as usize },
        1usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).ax as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).bx as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).cx as *const _ as usize },
        6usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).dx as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).si as *const _ as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).di as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).sp as *const _ as usize },
        14usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).bp as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).cs as *const _ as usize },
        18usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).ds as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).ss as *const _ as usize },
        22usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).fs as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).gs as *const _ as usize },
        26usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).es as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_real_mode_int_args>())).flags as *const _ as usize },
        30usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_real_mode_int_args),
...
extern "C" {
    #[link_name = "\u{1}__packed"]
    pub static mut __packed: nk_real_mode_int_args;
}
extern "C" {
    pub fn nk_real_mode_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_real_mode_deinit() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_real_mode_set_arg_defaults(args: *mut nk_real_mode_int_args);
}
extern "C" {
    pub fn nk_real_mode_start() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_real_mode_int(args: *mut nk_real_mode_int_args) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_real_mode_finish() -> ::libc::c_int;
}
