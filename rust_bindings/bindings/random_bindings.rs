...
#[test]
fn bindgen_test_layout_nk_rand_info() {
    assert_eq!(
        ::core::mem::size_of::<nk_rand_info>(),
        32usize,
        concat!("Size of: ", stringify!(nk_rand_info))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_rand_info>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_rand_info))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_rand_info>())).lock as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_rand_info),
            "::",
            stringify!(lock)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_rand_info>())).seed as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_rand_info),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_rand_info>())).xi as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_rand_info),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_rand_info>())).n as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_rand_info),
...
extern "C" {
    pub fn nk_rand_init(cpu: *mut cpu) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_rand_set_xi(xi: u64);
}
extern "C" {
    pub fn nk_rand_seed(seed: u64);
}
extern "C" {
    pub fn nk_get_rand_bytes(buf: *mut u8, len: ::libc::c_uint);
}
