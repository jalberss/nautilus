...
#[repr(C)]
#[derive(Copy, Clone)]
pub union nk_ticket_lock {
    pub val: u32,
    pub lock: nk_ticket_lock__bindgen_ty_1,
    _bindgen_union_align: u32,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_ticket_lock__bindgen_ty_1 {
    pub ticket: u16,
    pub users: u16,
}
#[test]
fn bindgen_test_layout_nk_ticket_lock__bindgen_ty_1() {
    assert_eq!(
        ::core::mem::size_of::<nk_ticket_lock__bindgen_ty_1>(),
        4usize,
        concat!("Size of: ", stringify!(nk_ticket_lock__bindgen_ty_1))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_ticket_lock__bindgen_ty_1>(),
        2usize,
        concat!("Alignment of ", stringify!(nk_ticket_lock__bindgen_ty_1))
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_ticket_lock__bindgen_ty_1>())).ticket as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_ticket_lock__bindgen_ty_1),
            "::",
            stringify!(ticket)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_ticket_lock__bindgen_ty_1>())).users as *const _ as usize
        },
        2usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout_nk_ticket_lock() {
    assert_eq!(
        ::core::mem::size_of::<nk_ticket_lock>(),
        4usize,
        concat!("Size of: ", stringify!(nk_ticket_lock))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_ticket_lock>(),
        4usize,
        concat!("Alignment of ", stringify!(nk_ticket_lock))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_ticket_lock>())).val as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_ticket_lock),
            "::",
            stringify!(val)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_ticket_lock>())).lock as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_ticket_lock),
...
pub type nk_ticket_lock_t = nk_ticket_lock;
extern "C" {
    pub fn nk_ticket_lock_init(l: *mut nk_ticket_lock_t);
}
extern "C" {
    pub fn nk_ticket_lock_deinit(l: *mut nk_ticket_lock_t);
}
extern "C" {
    pub fn nk_ticket_lock(l: *mut nk_ticket_lock_t);
}
extern "C" {
    pub fn nk_ticket_unlock(l: *mut nk_ticket_lock_t);
}
extern "C" {
    pub fn nk_ticket_trylock(l: *mut nk_ticket_lock_t) -> ::libc::c_int;
}
