...
pub const ATEXIT_MAX_FUNCS: u32 = 128;
...
pub struct atexit_func_entry_t {
    pub destructor_func: ::core::option::Option<unsafe extern "C" fn(arg1: *mut ::libc::c_void)>,
    pub obj_ptr: *mut ::libc::c_void,
    pub dso_handle: *mut ::libc::c_void,
}
#[test]
fn bindgen_test_layout_atexit_func_entry_t() {
    assert_eq!(
        ::core::mem::size_of::<atexit_func_entry_t>(),
        24usize,
        concat!("Size of: ", stringify!(atexit_func_entry_t))
    );
    assert_eq!(
        ::core::mem::align_of::<atexit_func_entry_t>(),
        8usize,
        concat!("Alignment of ", stringify!(atexit_func_entry_t))
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<atexit_func_entry_t>())).destructor_func as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(atexit_func_entry_t),
            "::",
            stringify!(destructor_func)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<atexit_func_entry_t>())).obj_ptr as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(atexit_func_entry_t),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<atexit_func_entry_t>())).dso_handle as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(atexit_func_entry_t),
            "::",
            stringify!(dso_handle)
        )
    );
}
...
pub struct _Unwind_Exception {
    pub empty: *mut ::libc::c_void,
}
#[test]
fn bindgen_test_layout__Unwind_Exception() {
    assert_eq!(
        ::core::mem::size_of::<_Unwind_Exception>(),
        8usize,
        concat!("Size of: ", stringify!(_Unwind_Exception))
    );
    assert_eq!(
        ::core::mem::align_of::<_Unwind_Exception>(),
        8usize,
        concat!("Alignment of ", stringify!(_Unwind_Exception))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<_Unwind_Exception>())).empty as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout__Unwind_Context() {
    assert_eq!(
        ::core::mem::size_of::<_Unwind_Context>(),
        8usize,
        concat!("Size of: ", stringify!(_Unwind_Context))
    );
    assert_eq!(
        ::core::mem::align_of::<_Unwind_Context>(),
        8usize,
        concat!("Alignment of ", stringify!(_Unwind_Context))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<_Unwind_Context>())).empty as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_Unwind_Context),
            "::",
            stringify!(empty)
        )
    );
...
extern "C" {
    pub fn __cxa_atexit(
        ...
        arg: *mut ::libc::c_void,
        __dso_handle: *mut ::libc::c_void,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn __cxa_finalize(f: *mut ::libc::c_void);
}
extern "C" {
