...
pub const NEMO_MAX_EVENTS: u32 = 1024;
pub const NEMO_INT_VEC: u32 = 232;
...
pub type nemo_action_t = ::core::option::Option<unsafe extern "C" fn()>;
pub type nemo_event_id_t = ::libc::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nemo_event {
    pub action: nemo_action_t,
    pub id: nemo_event_id_t,
    pub priv_data: *mut ::libc::c_void,
}
#[test]
fn bindgen_test_layout_nemo_event() {
    assert_eq!(
        ::core::mem::size_of::<nemo_event>(),
        24usize,
        concat!("Size of: ", stringify!(nemo_event))
    );
    assert_eq!(
        ::core::mem::align_of::<nemo_event>(),
        8usize,
        concat!("Alignment of ", stringify!(nemo_event))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nemo_event>())).action as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nemo_event),
            "::",
            stringify!(action)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nemo_event>())).id as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nemo_event),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nemo_event>())).priv_data as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nemo_event),
...
pub type nemo_event_t = nemo_event;
extern "C" {
    pub fn nemo_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nemo_register_event_action(
        func: ::core::option::Option<unsafe extern "C" fn()>,
        priv_data: *mut ::libc::c_void,
    ) -> nemo_event_id_t;
}
extern "C" {
    pub fn nemo_unregister_event_action(eid: nemo_event_id_t);
}
extern "C" {
    pub fn nemo_event_notify(eid: nemo_event_id_t, cpu: ::libc::c_int);
}
extern "C" {
    pub fn nemo_event_broadcast(eid: nemo_event_id_t);
}
extern "C" {
    pub fn nemo_event_await();
}
