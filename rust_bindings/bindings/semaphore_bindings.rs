...
pub const NK_SEMAPHORE_NAME_LEN: u32 = 32;
...
pub const nk_semaphore_type_t_NK_SEMAPHORE_DEFAULT: nk_semaphore_type_t = 0;
pub type nk_semaphore_type_t = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_semaphore {
    _unused: [u8; 0],
}
extern "C" {
    pub fn nk_semaphore_create(
        name: *mut ::libc::c_char,
        init_count: ::libc::c_int,
        type_: nk_semaphore_type_t,
        type_characteristics: *mut ::libc::c_void,
    ) -> *mut nk_semaphore;
}
extern "C" {
    pub fn nk_semaphore_find(name: *mut ::libc::c_char) -> *mut nk_semaphore;
}
extern "C" {
    pub fn nk_semaphore_attach(sem: *mut nk_semaphore);
}
extern "C" {
    pub fn nk_semaphore_release(s: *mut nk_semaphore);
}
extern "C" {
    pub fn nk_semaphore_up(s: *mut nk_semaphore);
}
extern "C" {
    pub fn nk_semaphore_down(s: *mut nk_semaphore);
}
extern "C" {
    pub fn nk_semaphore_try_down(s: *mut nk_semaphore) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_semaphore_down_timeout(s: *mut nk_semaphore, timeout_ns: u64) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_semaphore_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_semaphore_deinit();
}
extern "C" {
    pub fn nk_semaphore_dump_semaphores();
}
