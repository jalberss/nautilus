...
pub const TIMER_SPIN: u32 = 1;
pub const TIMER_CALLBACK: u32 = 2;
...
extern "C" {
    pub fn nk_alloc_timer() -> *mut nk_timer;
}
extern "C" {
    pub fn nk_free_timer(t: *mut nk_timer);
}
extern "C" {
    pub fn nk_set_timer(
        t: *mut nk_timer,
        ns: u64,
        flags: u64,
        callback: ::core::option::Option<unsafe extern "C" fn(p: *mut ::libc::c_void)>,
        p: *mut ::libc::c_void,
        cpu: u32,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_cancel_timer(t: *mut nk_timer) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_wait_timer(t: *mut nk_timer) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_sleep(ns: u64) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_delay(ns: u64) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_timer_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_timer_deinit();
}
extern "C" {
    pub fn nk_timer_handler() -> u64;
}
