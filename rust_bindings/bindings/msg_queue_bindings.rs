...
pub const NK_MSG_QUEUE_NAME_LEN: u32 = 32;
...
pub const nk_msg_queue_type_t_NK_MSG_QUEUE_DEFAULT: nk_msg_queue_type_t = 0;
pub type nk_msg_queue_type_t = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_msg_queue {
    _unused: [u8; 0],
}
extern "C" {
    pub fn nk_msg_queue_create(
        name: *mut ::libc::c_char,
        size: u64,
        type_: nk_msg_queue_type_t,
        type_characteristics: *mut ::libc::c_void,
    ) -> *mut nk_msg_queue;
}
extern "C" {
    pub fn nk_msg_queue_find(name: *mut ::libc::c_char) -> *mut nk_msg_queue;
}
extern "C" {
    pub fn nk_msg_queue_attach(queue: *mut nk_msg_queue);
}
extern "C" {
    pub fn nk_msg_queue_release(queue: *mut nk_msg_queue);
}
extern "C" {
    pub fn nk_msg_queue_full(queue: *mut nk_msg_queue) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_msg_queue_empty(queue: *mut nk_msg_queue) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_msg_queue_push(queue: *mut nk_msg_queue, msg: *mut ::libc::c_void);
}
extern "C" {
    pub fn nk_msg_queue_pull(queue: *mut nk_msg_queue, msg: *mut *mut ::libc::c_void);
}
extern "C" {
    pub fn nk_msg_queue_try_push(
        queue: *mut nk_msg_queue,
        msg: *mut ::libc::c_void,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_msg_queue_try_pull(
        queue: *mut nk_msg_queue,
        msg: *mut *mut ::libc::c_void,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_msg_queue_push_timeout(
        queue: *mut nk_msg_queue,
        msg: *mut ::libc::c_void,
        timeout_ns: u64,
    ) -> ::libc::c_int;
...
extern "C" {
    pub fn nk_msg_queue_pull_timeout(
        queue: *mut nk_msg_queue,
        msg: *mut *mut ::libc::c_void,
        timeout_ns: u64,
    ) -> ::libc::c_int;
...
extern "C" {
    pub fn nk_msg_queue_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_msg_queue_deinit();
}
extern "C" {
    pub fn nk_msg_queue_dump_queues();
}
