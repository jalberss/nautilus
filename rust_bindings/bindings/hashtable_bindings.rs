...
extern "C" {
    pub fn nk_hash_long(val: ulong_t, bits: uint_t) -> ulong_t;
}
extern "C" {
    pub fn nk_hash_buffer(msg: *mut uchar_t, length: uint_t) -> ulong_t;
}
extern "C" {
    pub fn nk_create_htable(
        min_size: uint_t,
        hashfunction: ::core::option::Option<unsafe extern "C" fn(key: addr_t) -> uint_t>,
        key_eq_fn: ::core::option::Option<
            unsafe extern "C" fn(key1: addr_t, key2: addr_t) -> ::libc::c_int,
        >,
    ) -> *mut nk_hashtable;
}
extern "C" {
    pub fn nk_free_htable(
        htable: *mut nk_hashtable,
        free_values: ::libc::c_int,
        free_keys: ::libc::c_int,
    );
}
extern "C" {
    pub fn nk_htable_insert(htable: *mut nk_hashtable, key: addr_t, value: addr_t)
        -> ::libc::c_int;
}
extern "C" {
    pub fn nk_htable_change(
        htable: *mut nk_hashtable,
        key: addr_t,
        value: addr_t,
        free_value: ::libc::c_int,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_htable_search(htable: *mut nk_hashtable, key: addr_t) -> addr_t;
}
extern "C" {
    pub fn nk_htable_remove(
        htable: *mut nk_hashtable,
        key: addr_t,
        free_key: ::libc::c_int,
    ) -> addr_t;
...
extern "C" {
    pub fn nk_htable_count(htable: *mut nk_hashtable) -> uint_t;
}
extern "C" {
    pub fn nk_htable_inc(htable: *mut nk_hashtable, key: addr_t, value: addr_t) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_htable_dec(htable: *mut nk_hashtable, key: addr_t, value: addr_t) -> ::libc::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_hashtable_iter {
    pub htable: *mut nk_hashtable,
    pub entry: *mut nk_hash_entry,
    pub parent: *mut nk_hash_entry,
    pub index: uint_t,
}
#[test]
fn bindgen_test_layout_nk_hashtable_iter() {
    assert_eq!(
        ::core::mem::size_of::<nk_hashtable_iter>(),
        32usize,
        concat!("Size of: ", stringify!(nk_hashtable_iter))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_hashtable_iter>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_hashtable_iter))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_hashtable_iter>())).htable as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_hashtable_iter),
            "::",
            stringify!(htable)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_hashtable_iter>())).entry as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_hashtable_iter),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_hashtable_iter>())).parent as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_hashtable_iter),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_hashtable_iter>())).index as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_hashtable_iter),
...
extern "C" {
    pub fn nk_create_htable_iter(htable: *mut nk_hashtable) -> *mut nk_hashtable_iter;
}
extern "C" {
    pub fn nk_destroy_htable_iter(iter: *mut nk_hashtable_iter);
}
extern "C" {
    pub fn nk_htable_get_iter_key(iter: *mut nk_hashtable_iter) -> addr_t;
}
extern "C" {
    pub fn nk_htable_get_iter_value(iter: *mut nk_hashtable_iter) -> addr_t;
}
extern "C" {
    pub fn nk_htable_iter_advance(iter: *mut nk_hashtable_iter) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_htable_iter_remove(
        iter: *mut nk_hashtable_iter,
        free_key: ::libc::c_int,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_htable_iter_search(
        iter: *mut nk_hashtable_iter,
        htable: *mut nk_hashtable,
        key: addr_t,
    ) -> ::libc::c_int;
