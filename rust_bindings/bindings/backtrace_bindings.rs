...
extern "C" {
    pub fn __do_backtrace(arg1: *mut *mut ::libc::c_void, arg2: ::libc::c_uint);
}
extern "C" {
    pub fn nk_dump_mem(arg1: *mut ::libc::c_void, arg2: ulong_t);
}
extern "C" {
    pub fn nk_stack_dump(arg1: ulong_t);
}
extern "C" {
    pub fn nk_print_regs(r: *mut nk_regs);
}
