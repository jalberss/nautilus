...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_block_dev_characteristics {
    pub block_size: u64,
    pub num_blocks: u64,
}
#[test]
fn bindgen_test_layout_nk_block_dev_characteristics() {
    assert_eq!(
        ::core::mem::size_of::<nk_block_dev_characteristics>(),
        16usize,
        concat!("Size of: ", stringify!(nk_block_dev_characteristics))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_block_dev_characteristics>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_block_dev_characteristics))
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_block_dev_characteristics>())).block_size as *const _
                as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_block_dev_characteristics),
            "::",
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_block_dev_characteristics>())).num_blocks as *const _
                as usize
        },
        8usize,
        concat!(
...
pub const nk_block_dev_status_t_NK_BLOCK_DEV_STATUS_SUCCESS: nk_block_dev_status_t = 0;
pub const nk_block_dev_status_t_NK_BLOCK_DEV_STATUS_ERROR: nk_block_dev_status_t = 1;
pub type nk_block_dev_status_t = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_block_dev_int {
    pub dev_int: nk_dev_int,
    pub get_characteristics: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            c: *mut nk_block_dev_characteristics,
        ) -> ::libc::c_int,
    >,
    pub read_blocks: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            blocknum: u64,
            count: u64,
            ...
            callback: ::core::option::Option<
                unsafe extern "C" fn(status: nk_block_dev_status_t, context: *mut ::libc::c_void),
            >,
            context: *mut ::libc::c_void,
        ) -> ::libc::c_int,
    >,
    pub write_blocks: ::core::option::Option<
        unsafe extern "C" fn(
            state: *mut ::libc::c_void,
            blocknum: u64,
            count: u64,
...
#[test]
fn bindgen_test_layout_nk_block_dev_int() {
    assert_eq!(
        ::core::mem::size_of::<nk_block_dev_int>(),
        40usize,
        concat!("Size of: ", stringify!(nk_block_dev_int))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_block_dev_int>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_block_dev_int))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_block_dev_int>())).dev_int as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_block_dev_int),
            "::",
            stringify!(dev_int)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nk_block_dev_int>())).get_characteristics as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_block_dev_int>())).read_blocks as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_block_dev_int),
            "::",
            stringify!(read_blocks)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_block_dev_int>())).write_blocks as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_block_dev_int),
            "::",
            stringify!(write_blocks)
        )
    );
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nk_block_dev {
    pub dev: nk_dev,
}
#[test]
fn bindgen_test_layout_nk_block_dev() {
    assert_eq!(
        ::core::mem::size_of::<nk_block_dev>(),
        88usize,
        concat!("Size of: ", stringify!(nk_block_dev))
    );
    assert_eq!(
        ::core::mem::align_of::<nk_block_dev>(),
        8usize,
        concat!("Alignment of ", stringify!(nk_block_dev))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nk_block_dev>())).dev as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nk_block_dev),
            "::",
            stringify!(dev)
        )
    );
...
extern "C" {
    pub fn nk_block_dev_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_block_dev_deinit() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_block_dev_register(
        name: *mut ::libc::c_char,
        flags: u64,
        inter: *mut nk_block_dev_int,
        state: *mut ::libc::c_void,
    ) -> *mut nk_block_dev;
}
extern "C" {
    pub fn nk_block_dev_unregister(arg1: *mut nk_block_dev) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_block_dev_find(name: *mut ::libc::c_char) -> *mut nk_block_dev;
}
extern "C" {
    pub fn nk_block_dev_get_characteristics(
        d: *mut nk_block_dev,
        c: *mut nk_block_dev_characteristics,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_block_dev_read(
        dev: *mut nk_block_dev,
        blocknum: u64,
        count: u64,
        dest: *mut ::libc::c_void,
        type_: nk_dev_request_type_t,
        callback: ::core::option::Option<
            unsafe extern "C" fn(status: nk_block_dev_status_t, state: *mut ::libc::c_void),
        >,
        state: *mut ::libc::c_void,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_block_dev_write(
        dev: *mut nk_block_dev,
        blocknum: u64,
        count: u64,
        src: *mut ::libc::c_void,
