...
pub const NK_MTRR_HAS_FIXED: u32 = 1;
pub const NK_MTRR_HAS_WC: u32 = 2;
pub const NK_MTRR_HAS_SMRR: u32 = 4;
pub const NK_MTRR_TYPE_UC: u32 = 0;
pub const NK_MTRR_TYPE_WC: u32 = 1;
pub const NK_MTRR_TYPE_WT: u32 = 4;
pub const NK_MTRR_TYPE_WP: u32 = 5;
pub const NK_MTRR_TYPE_WB: u32 = 6;
...
extern "C" {
    pub fn nk_mttr_get_features(
        num_var: *mut ::libc::c_int,
        flags: *mut ::libc::c_int,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_get_default(
        enable: *mut ::libc::c_int,
        fixed_enable: *mut ::libc::c_int,
        type_: *mut u8,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_set_default(
        enable: ::libc::c_int,
        fixed_enable: ::libc::c_int,
        type_: u8,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_addr_to_fixed_num(addr: *mut ::libc::c_void) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_fixed_num_to_range(
        num: ::libc::c_int,
...
extern "C" {
    pub fn nk_mtrr_get_fixed(num: ::libc::c_int, type_: *mut u8) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_set_fixed(num: ::libc::c_int, type_: u8) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_get_variable(
        num: ::libc::c_int,
        start: *mut *mut ::libc::c_void,
        end: *mut *mut ::libc::c_void,
        type_: *mut u8,
...
extern "C" {
    pub fn nk_mtrr_find_type(
        addr: *mut ::libc::c_void,
        type_: *mut u8,
        typestr: *mut *mut ::libc::c_char,
    ) -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_dump(cpu: ::libc::c_int);
}
extern "C" {
    pub fn nk_mtrr_init() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_init_ap() -> ::libc::c_int;
}
extern "C" {
    pub fn nk_mtrr_deinit();
}
